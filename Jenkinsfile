	        ...
	        container('helm') {
	                ...
	                usernamePassword(
	                  ...
	                  usernameVariable: 'NX_USER', passwordVariable: 'NX_PASS'
	                    ...
	                    sh "helm package hw-${BUILD_NUMBER}"
	                    sh "curl -u ${NX_USER}:${NX_PASS} http://ae183eab50180425691974eb08081fd2-1806456043.us-east-1.elb.amazonaws.com:8081/repository/bdop-charts/ --upload-file hw-${BUILD_NUMBER}.tgz -v"
